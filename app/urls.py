...
urlpatterns = [
    ...
    path('get_all_recommended_Imaging_list/',views.get_all_recommended_Imaging_list),
    ...
    path('list_of_images_based_on_resolution/<int:resolution>/',views.list_of_images_based_on_resolution),
